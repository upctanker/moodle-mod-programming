<?php
    ...
    programming_presetcode_adjust_sequence($a, $id, $direction);
    add_to_log($course->id, 'programming', 'presetcode_delete', "presetcode/move.php?a={$programming->id}", 'move preset code');
    redirect("list.php?a=$programming->id", get_string('presetcodemoved', 'programming'), 0);
