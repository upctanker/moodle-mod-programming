<?php
    ...
    programming_testcase_adjust_sequence($a, $id, $direction);
    add_to_log($course->id, 'programming', 'testcase_delete', "testcase/move.php?a={$programming->id}", 'move data file');
    redirect("list.php?a=$programming->id", get_string('testcasemoved', 'programming'), 0);
